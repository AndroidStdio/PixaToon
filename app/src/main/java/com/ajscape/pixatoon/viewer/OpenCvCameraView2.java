...
public class OpenCvCameraView2 extends CameraBridgeViewBase implements PreviewCallback, Camera.PictureCallback {
    ...
    public OpenCvCameraView2(Context context, int cameraId) {
        super(context, cameraId);
    }

    public OpenCvCameraView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (OpenCvCameraView2.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            OpenCvCameraView2.this.wait();
                        }
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
